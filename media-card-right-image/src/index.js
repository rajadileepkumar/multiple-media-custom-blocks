...
registerBlockType( 'media-card/media-card-right-image-esnext', {
	title: __( 'Media Card Right image', 'gutenberg-examples' ),
	...
	edit: ( props ) => {
		...
		return (
			<div className={ className }>
				<div className={ className }>
					<h2>Media Breaker Block with Image Right-Side Content</h2>
