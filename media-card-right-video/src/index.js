...
registerBlockType( 'media-card/media-card-right-video-esnext', {
	title: __( 'Media Card Right Video', 'gutenberg-examples' ),
	...
	edit: ( props ) => {
		...
		return (
			<div className={ className }>
				<div className={ className }>
					<h2>Media Breaker Block with Video Right-Side Content</h2>
