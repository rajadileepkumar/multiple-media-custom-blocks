...
registerBlockType( 'media-card/media-card-left-video-esnext', {
	title: __( 'Media Card Left Video', 'gutenberg-examples' ),
	...
	edit: ( props ) => {
		...
		return (
			<div className={ className }>
				<div className={ className }>
					<h2>Media Breaker Block with Video Left-Side Content</h2>
